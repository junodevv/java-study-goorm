...
public class Main {
    public static void main(String[] args)
        ...
        //  💡 클래스를 가져오는 두 방법
        //  - 와일드카드<?> 사용 가능
        Class<Button> btnClass1 = Button.class; // 이 인스턴스는 해당 클래스에 대한 정보를 가지고 있음
        //  예외 던짐 : ClassNotFoundException
        Class<?> btnClass2 = Class.forName("sec13.chap01.ex01.Button");
        // => 이름으로 클래스를 가져온다. 어떤 형식인지 모르기 때문에 <?> 를 넣어준다.
        ...
        // 이때 newInstance 메소드가 반환하는 타입이 T 이기 때문에 Button으로 명시하여 형변환 해줘야 Button에 할당할 수 있다.
        ...
        //Field bstnSpaces = btnClass1.getField("spaces"); //
